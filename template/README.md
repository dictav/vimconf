VimConfXXXX Webサイト作成に関する issue はこちら https://github.com/vim-jp/vimconf/issues/67

---

# VimConfXXXX

このディレクトリは VimConfXXXX のためのものです。
ディレクトリ配下のファイルは https://vimconf.vim-jp.org/XXXX/ に公開されます。
...
* `_data/XXXX` 配下のYAMLファイルからページの生成及び `info.json` ファイルの生成 [[Data Files](http://jekyllrb.com/docs/datafiles/)]
* `_layout/XXXX/default.html` を使ってレイアウトを定義
...
3. Check your site - https://yourname.github.io/vimconf/XXXX
